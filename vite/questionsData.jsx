    ...
    "board-data": [
        ...
        [
            ...
            },
            {
                ...
                "answer": <ul style={{columnCount: 3, columnGap: "15%"}}><li>Chewa</li><li>Chibarwe</li><li>Kalanga</li><li>Koisan</li><li>Nambya</li><li>Ndau</li><li>Ndebele</li><li>Shangani</li><li>Shona</li><li>Sign Language</li><li>Sotho</li><li>Tonga</li><li>Tswana</li><li>Venda</li><li>Xhosa</li></ul>
            },
            {
                "value": 500,
